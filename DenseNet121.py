...
callbacks = [
    SafeModelCheckpoint(os.path.join(results_dir, 'ForestFire_detection_DenseNet121.keras'),
                        verbose=1,
                        save_best_only=True,
...
plt.legend()
plt.title('Accuracy')
plt.savefig(os.path.join(results_dir, 'densenet121_accuracy_plot.png'))
...
plt.legend()
plt.title('Loss')
plt.savefig(os.path.join(results_dir, 'densenet121_loss_plot.png'))
...
plt.savefig(os.path.join(results_dir, 'densenet121_confusion_matrix.png'))
...
plt.savefig(os.path.join(results_dir, 'densenet121_normalized_confusion_matrix.png'))
